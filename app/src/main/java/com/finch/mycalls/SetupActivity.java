...
public class SetupActivity extends ActionBarActivity {
    ...
    public void onFinishClicked(View v) {
        ...
        String[] stateIDs = this.getResources().getStringArray(R.array.circle_state_codes);
        ...
        if(((RadioButton)(mode.getChildAt(0))).isChecked()){
            e.putString(AppGlobals.PKEY_MODE_OF_CALCULATION, String.valueOf(AppGlobals.MODE_MINUTES));
        }else{
            e.putString(AppGlobals.PKEY_MODE_OF_CALCULATION, String.valueOf(AppGlobals.MODE_SECONDS));
        }
    ...
    public class FloatViewsTransform implements ViewPager.PageTransformer {
        ...
        public void transformPage(View view, float position) {
            ...
            if (position < -1) { // [-Infinity,-1)
                ...
                //page 1
                TextView w1=(TextView)view.findViewById(R.id.welcome_text1);
                TextView w2=(TextView)view.findViewById(R.id.welcome_text2);
                ...
                if(finish!=null) finish.setAlpha(1-Math.abs(position));
